...
#define DEFAULT_NOMINAL_FILAMENT_DIA 0
...
#define DELTA
  ...
  #define DELTA_DIAGONAL_ROD 445.0 // mm
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 128, 128, 80, 760*1.1 }  // default steps per unit for Kossel (GT2, 20 tooth)
